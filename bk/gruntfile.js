module.exports = function(grunt){
	grunt.initConfig({
		...
		cssmin: {
			target: {
				files: [{
					expand: true,
					cwd: 'assets/css',
					src: ['style.css','font-awesome.css','bootstrap.css','style.css'],
					dest: 'assets/css',
					ext: '.min.css'
				}]
			}
		...
		jshint: {
			all:['build/js/waadmin/*.js', 'build/js/*.js']
		},
		concat: {
			basic_and_extras: {
				files: {
					'assets/js/script.js': ['build/js/variables.js','build/js/functions.js','build/js/script.js'],
				},
			},
		},
		uglify: {
